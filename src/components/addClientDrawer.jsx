        ...
        return (
            <div>
                <mat.Drawer open={this.state.open} width={500} openSecondary={true} docked={true}>
                    <mat.AppBar title="" iconElementLeft={<mat.IconButton><NavigationArrowForward /></mat.IconButton>} //rgb(255, 97, 85)
                        onLeftIconButtonTouchTap={this.handleToggle.bind(this, null)} style={{ backgroundColor: "#008080" }} />
